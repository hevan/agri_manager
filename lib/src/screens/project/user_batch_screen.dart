...
class UserBatchProductScreen extends StatefulWidget {
  const UserBatchProductScreen({Key? key}) : super(key: key);

  @override
  State<UserBatchProductScreen> createState() => _UserBatchProductScreenState();
}

class _UserBatchProductScreenState extends State<UserBatchProductScreen> {
