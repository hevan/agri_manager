...
class CmsBlogHtmlVideoScreen extends StatefulWidget {
  final int? id;
  final String? title;
  final String? videoUrl;
  const CmsBlogHtmlVideoScreen({Key? key, this.id, this.title, this.videoUrl}) : super(key: key);

  @override
  State<CmsBlogHtmlVideoScreen> createState() => _CmsBlogHtmlVideoScreenState();
}

class _CmsBlogHtmlVideoScreenState extends State<CmsBlogHtmlVideoScreen> {
