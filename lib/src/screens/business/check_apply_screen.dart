...
class CheckApplyScreen extends StatefulWidget {
  final int? userId;
  final int? corpId;
  final int? status;
  const CheckApplyScreen({Key? key, this.userId, this.corpId, this.status}) : super(key: key);

  @override
  State<CheckApplyScreen> createState() => _CheckApplyScreenState();
}

class _CheckApplyScreenState extends State<CheckApplyScreen>{
