...
import 'package:znny_manager/src/shared_components/list_profil_image.dart';
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: _Tile(
                dotColor: TypeStatus.getTaskStatusColor(data.status!),
                title: data.name!,
                subtitle: TypeStatus.taskStatustoStringValue(data.status!),
                ...
                children: [
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      elevation: 0,
                      primary: TypeStatus.getTaskStatusColor(data.status!),
                      shape: RoundedRectangleBorder(
                    ...
                    child: Text(
                      TypeStatus.taskStatustoStringValue(data.status!),
                    ),
                  )
                ],
              ),
